...
samples_member = data[:8000]
samples_nonmember = data[8000:9000]
sample_path = f'SamplesDatabase/{file_name}/TargetModel'
index_folder_path = f"VectorDatabase/{file_name}/TargetModel"
